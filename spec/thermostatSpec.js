...
beforeEach(function(){
  ...
  describe('saving status mode', function(){
    it('returns a string that tell us in which mode we are', function(){
      expect(thermostat.savingMode()).toEqual(thermostat._powerSaving);
    });
